...
export default function IndexPage() {
  ...
  const columns = [
    ...
    { title: '类型', dataIndex: 'logType', key: 'logType', width: 200, fixed: true },
    {
  ...
  return (
    <div className={styles.logIndex}>
      ...
      <div style={{ display: current === 'logInfo' ? 'block' : 'none', marginTop: 10 }}>
        ...
        <Table
          ...
          scroll={{ y: 650 }}
          expandable={{
            expandedRowRender: record => <p style={{ margin: 0 }}>{record.loggerInfo}</p>,
          }}
